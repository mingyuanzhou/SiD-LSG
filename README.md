...
We are actively developing an improved version of **SiD-LSG**, which will be placed in a separate branch and introduce the following enhancements (Update: the features promised below are now available at [sid-dit](https://github.com/apple/ml-sid-dit); our team at UT Austin is also preparing releasing the distilled checkpoints on SANA/SD3-Medium/SD3.5-Medium/SD3.5-Large/FLUX.1-dev to HuggineFace):  
